"""
The fiber admin is a separate admin site,
that contains the screens for the frontend admin.
"""
from django.contrib import admin
from mptt.admin import MPTTModelAdmin
from fiber.admin.contentitemadmin import ContentItemAdminForm
from fiber.admin.pageadmin import PageForm
